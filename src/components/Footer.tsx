    ...
    <div className="relative w-full overflow-hidden flex flex-col items-center justify-start">
      <section className="self-stretch relative h-[698px] text-left text-base text-white font-desktop-paragraph">
        ...
        <h3 className="m-0 absolute w-[27.01%] top-[17.19%] left-[4.39%] text-5xl font-normal font-inherit inline-block">
          ...
          <div className="absolute text-2xl mt-5 underline">Subscribe to our newsletter</div>
        </h3>

        <div className="absolute grid grid-rows-11 grid-cols-2 gap-y-2 gap-x-10 top-[17.19%] right-[4.39%]">
          <div>Home</div>
          <div>Offices</div>
          <div>Auckland - NZ</div>
          <div>Essex - UK</div>
        ...
        <div className="absolute top-[56.16%] left-[66.91%]">©2023 WASSP</div>
        <Image
